...
public class FavoriteProductFragment extends Fragment {
    public static final String TAG = FavoriteProductFragment.class.getName();
    private View mView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView = inflater.inflate(R.layout.fragment_favorite_product, container, false);
        initUi();
        callProduct();
        return mView;
    }
    ...
    private void callProduct() {
        ...
        ProductService.productService.findAllProductFavorite(mMainActivity.getAccountID(),mMainActivity.getAuthorization())
